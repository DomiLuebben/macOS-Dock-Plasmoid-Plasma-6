...
case "$LOCALE_NAME" in
    de*)
        ...
        MSG_NO_CMAKE='FEHLER: cmake wurde nicht gefunden und wird zum Bau des Blur-Moduls benötigt.'
        ...
        MSG_BUILD='==> Baue natives Blur-Modul ...'
    ...
    fr*)
        ...
        MSG_NO_CMAKE='ERREUR : cmake est introuvable et est nécessaire pour compiler le module de flou.'
        ...
        MSG_BUILD='==> Compilation du module de flou natif...'
    ...
    *)
        ...
        MSG_NO_CMAKE='ERROR: cmake was not found and is required to build the blur module.'
        ...
        MSG_BUILD='==> Building the native blur module...'
...
# Keep all build output inside the checked-out project. The directory is
# ignored by Git and can be reused by subsequent installations.
